...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1cced6ebd0f33c92: (a: number, b: number) => void;
